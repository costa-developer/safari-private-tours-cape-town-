...
// Card component with frosted glass effect for text visibility
export const Card = ({ card }: { card: Card }) => {
  return (
    <div className="relative flex h-80 w-56 flex-col justify-between overflow-hidden rounded-3xl bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900">
      ...
      {/* Bottom full-width price & period with Frosted Glass effect */}
      <div className="absolute bottom-0 left-0 w-full z-10 backdrop-blur-md bg-black/40 px-6 py-3 flex justify-between items-center rounded-b-3xl">
