...
export const Card = ({ card }: { card: Card }) => {
  return (
    <div className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900">
      ...
      {/* Bottom-left price and period */}
      <div className="absolute bottom-8 left-8 z-40 flex flex-col items-start gap-1 bg-white">
        <p className="font-sans text-white text-xl font-semibold">{card.price}</p>
        <p className="font-sans text-white text-sm font-medium">{card.period}</p>
      </div>
