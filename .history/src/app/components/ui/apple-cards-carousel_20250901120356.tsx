  ...
  return (
    <>
      ...
      >
        ...
        {/* Updated section for title and price/period */}
        ...
        {/* New div for bottom left price and period */}
        <div className="absolute bottom-8 left-8 z-40 flex flex-col items-start gap-1 text-white">
          <p className="font-sans text-white text-xl font-semibold">
            {card.price}
          </p>
