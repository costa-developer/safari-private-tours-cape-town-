    ...
    <>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              ...
              {/* Price and Period */}
              <div className="mt-2 flex gap-6 text-sm font-medium text-neutral-600 dark:text-neutral-400">
      ...
      >
        ...
        <div className="relative z-40 p-8">
          ...
          <motion.p className="mt-1 text-white text-sm">
...
// Example data with price and period
export const data: Card[] = [
  {
    ...
    content: (
      <div>
        Take in breathtaking panoramic views of Cape Town from the top of Table Mountain, whether you hike up or ride the cable car.
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        Explore the dramatic cliffs of Cape Point, visit Boulders Beach to meet the African penguins, and enjoy one of the world’s most scenic drives.
      </div>
    ),
  },
];
