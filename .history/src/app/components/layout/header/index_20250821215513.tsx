...
const Header = () => {
    ...
    return (
        <header
            ...
            before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-0  before:transition-all before:duration-500 before:ease-in-out
            ${sticky ? "before:h-full bg-white/10 backdrop-blur-md" : "before:h-0 bg-transparent"}`}
        >
                            ...
                            {menuOpen === false ?
                                <div className="flex align-middle">
                                    <button onClick={() => setMenuOpen(true)}>
                                        <Image src={sticky ? "/images/Icon/menu-button-sticky.svg" : "/images/Icon/menu-button.svg"} alt="Menu Icon" width={45} height={45} className="cursor-pointer" />
                                    </button>
                                </div>
                                :
                                <div
                                ...
                                >
                                    <div className="flex items-center justify-between pb-5 border-b border-secondary/15 dark:border-white/15">
                                        ...
                                        <div onClick={() => setMenuOpen(false)} className="p-2 cursor-pointer">
                                            <Image src="/images/Icon/close-icon.svg" alt="Close Icon" width={16} height={16} className="dark:hidden" />
                                            <Image src="/images/Icon/close-icon-dark.svg" alt="Close Icon Dark" width={16} height={16} className="hidden dark:block" />
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        {/* Updated contact info for Zim Catholic Community */}
                                        <Link href="tel:+27-000-000-0000" className="text-secondary/60 dark:text-white/60 hover:text-secondary dark:hover:text-white">+27-000-000-0000</Link>
                                        <Link href="mailto:info@zimromact.co.za"><h4>info@zimromact.co.za</h4></Link>
                                    </div>
                                </div>
                            }
                        </div>
