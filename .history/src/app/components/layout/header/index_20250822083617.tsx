                            ...
                            {!menuOpen ? (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <Link href="tel:+27-000-000-0000" className="text-secondary/60 dark:text-white/60 hover:text-secondary dark:hover:text-white">
                                            +27-000-000-0000
                                        </Link>
                                        <Link href="mailto:info@zimromact.co.za">
                                            <h4>info@zimromact.co.za</h4>
                                        </Link>
                                    </div>
                                </div>
                            )}
