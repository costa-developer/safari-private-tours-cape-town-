            ...
            <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
              <div className="flex flex-col gap-11">
                <div className="flex flex-col gap-5">
                  {/* Improved text size for mobile */}
                  <h2 className="max-w-3xl text-3xl md:text-4xl text-white">{UpcomingEventsData?.heading}</h2>
                  <p className="max-w-2xl text-base md:text-lg text-white/70">{UpcomingEventsData?.description}</p>
                </div>
              </div>
            </div>
