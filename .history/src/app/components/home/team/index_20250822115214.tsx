                    ...
                    <div className="flex flex-col gap-14 xl:gap-24">
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            <div className="flex items-center py-3 gap-4 md:gap-8 w-full max-w-xl">
                                ...
                                <p className="section-bedge py-1.5 px-4 rounded-full">Our Ministry Team</p>
                            </div>
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5">
                                    <h2 className="max-w-3xl">Meet Our Church Leaders</h2>
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                        Our dedicated leadership team guides the Zimbabwean Roman Catholic community in Cape Town. 
                                        Through prayer, pastoral care, and community engagement, they foster spiritual growth, unity, and service.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                return (
                                    <div key={index} className="group flex flex-col gap-6">
                                        <div className="relative">
                                            <Image src={data?.image} alt={data?.name} width={390} height={470} style={{ width: '100%' }} />
