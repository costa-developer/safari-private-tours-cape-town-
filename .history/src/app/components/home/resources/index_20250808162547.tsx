                            ...
                            <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                                ...
                                <div className="flex flex-col gap-11">
                                    <div className="flex flex-col gap-5 ">
                                        ...
                                        <p className="max-w-2xl text-secondary/70 dark:text-white/70"> Stay informed with DigitalizeIQ's latest articles, industry trends, and expert insights. Discover how innovative digital marketing and creative web solutions are shaping the future of brands and businesses.</p>
                                    </div>
                                </div>
                            </div>
