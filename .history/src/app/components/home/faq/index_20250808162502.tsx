                                ...
                                <div className="flex flex-col gap-11">
                                    <div className="flex flex-col gap-5 ">
                                        ...
                                        <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                          Get answers to common questions about how DigitalizeIQ customizes solutions to fit your unique business needs, delivering effective strategies, personalized branding, and outstanding customer service.
                                        </p>
                                    </div>
                                </div>
                            </div>
