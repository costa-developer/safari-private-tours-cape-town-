                    ...
                    <div className="flex flex-col gap-14 xl:gap-24">
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            <div className="flex items-center py-3 gap-4 md:gap-8 w-full max-w-xl">
                                <span className="section-bedge dark:text-white py-1.5 px-2.5 text-white font-medium rounded-full">{contactdataNumber ? contactdataNumber : 10}</span>
                                <div className="h-px w-16 bg-black/12 dark:bg-white/12" />
                                <p className="section-bedge py-1.5 px-4 rounded-full">Contact us</p>
                            </div>
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    <h2 className="max-w-3xl">Reach Out to Our Parish</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="max-w-md flex flex-col gap-9 md:gap-16">
                            <div className="flex flex-col gap-5 md:gap-8">
                                <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                    We’d love to hear from you! Whether you have prayer requests, want to join our community, or have questions about events and ministries, feel free to reach out.
                                </p>
                                <div>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:gap-8">
                                ...
                                {submitted && (
                                    <div className="flex gap-1.5">
                                        ...
                                        <p className="text-secondary">Thank you! Your message has been sent. We will get in touch soon.</p>
                                    </div>
                                )}
                                <div>
                                    {!loader ? (
