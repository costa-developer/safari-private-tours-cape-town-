...
const MinistriesSite = ({ backgroundImage, title, subtitle, peopleJoined }: MinistriesProps) => {
  return (
    <div
      className="h-full w-full min-w-[1100px] bg-contain bg-no-repeat lg:rounded-r-3xl 2xl:rounded-3xl"
...
const Ministries = () => {
    return (
      <section className="2xl:max-w-[1920px] relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
        ...
        <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start  overflow-x-auto lg:h-[400px] xl:h-[640px]">
          <MinistriesSite
