...
const Ministries = () => {
    return (
      <section className="2xl:max-w-[1920px] relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
        ...
        {/* Mobile-only heading, now centered */}
        <h3 className="block lg:hidden 2xl:max-w-3xl text-secondary dark:text-white font-semibold text-center">
