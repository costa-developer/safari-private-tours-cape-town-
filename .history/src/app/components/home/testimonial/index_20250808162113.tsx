                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    ...
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                        Genuine stories from businesses who trusted DigitalizeIQ — showcasing how our innovative solutions have elevated their brands and delivered measurable results.
                                    </p>
                                </div>
                            </div>
                        </div>
