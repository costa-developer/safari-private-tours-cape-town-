...
const CustomeJourneys = () => {
  return (
    ...
    >
      {/* Darker overlay for dim effect */}
      <div className="absolute inset-0 bg-black/60"></div>

      {/* Centered Content */}
      <div className="relative z-10 max-w-4xl text-center px-6 ml-[242px] mr-[242px]">
        {/* Sub-heading */}
        <h3 className="text-lg lg:text-[14px] font-medium text-white mb-4 uppercase tracking-widest">
        ...
        {/* Paragraph */}
        <p className="text-white/90 text-sm sm:text-base lg:text-[16px] mb-8 max-w-3xl mx-auto">
