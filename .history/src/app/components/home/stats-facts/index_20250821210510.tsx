...
function StatsFacts() {
    ...
    return (
        <section className="relative bg-[#1F2A2E] overflow-hidden">
            <div className="relative py-20 md:py-40 z-10">
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row gap-11 items-center justify-center text-center md:text-left">
