...
const statsFactData = {
  number: '02',
  name: "Stats & Facts",
  heading: "Cape Town's Tourism by the Numbers",
  description: "Cape Town is a leading global tourism destination, attracting millions of visitors each year with its stunning natural beauty, rich history, and vibrant culture. The city's tourism sector is a major economic driver, supporting a wide range of jobs and businesses, and is a key contributor to the Western Cape's overall economy.",
  scoreData: [
    { number: 4.7, numberValue: 'M+', scoreDescp: "Visitors welcomed to Cape Town annually, a number that continues to grow" },
    { number: 106, numberValue: 'K+', scoreDescp: "Jobs supported directly and indirectly by the city's tourism industry" },
    { number: 948, numberValue: 'K+', scoreDescp: "Annual visitors to Table Mountain, one of the world's most iconic attractions" },
    { number: 66, numberValue: '%', scoreDescp: "Hotel occupancy rate in 2024, a testament to the city's popularity" },
  ],
};
