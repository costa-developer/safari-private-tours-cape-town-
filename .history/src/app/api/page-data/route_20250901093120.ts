...
const statsFactData = {
  ...
  heading: "Cape Town's Tourism: A World-Class Success Story",
  description: "As the reigning 'Best City in the World' (Time Out, 2025), Cape Town isn't just a destination—it's a global phenomenon. Our thriving tourism sector is driven by record-breaking visitor numbers, solidifying our place as a top travel hub and a powerful economic force in South Africa.",
  scoreData: [
    { number: 4.7, numberValue: 'M+', scoreDescp: "Visitors welcomed annually, cementing our status as Africa’s premier city destination" },
    { number: 1, scoreDescp: "Voted the #1 'Best City in the World' by Time Out in 2025" },
    { number: 948, numberValue: 'K+', scoreDescp: "Annual visitors to Table Mountain, a testament to our iconic natural wonders" },
    { number: 106, numberValue: 'K+', scoreDescp: "Jobs created and sustained by the tourism sector, fueling our local economy" },
  ],
};
...
const UpcomingEventsData = { 
  ...
  description: "Experience the beauty and culture of Cape Town through guided tours, breathtaking landscapes, historic landmarks, vibrant neighborhoods, and unforgettable adventures. Join us and explore the best the Mother City has to offer.",
};
