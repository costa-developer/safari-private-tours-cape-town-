...
const statsFactData = {
  number: '01',
  name: "Stats & facts",
  heading: "High quality Full Stack Web Development solutions you can trust.",
  description: "DigitalizeIQ delivers enterprise-level web development across both the front and back end. Our expertise spans web applications, database development, user interface and digital design, server deployment, and much more.",
  scoreData: [
    { number: 40, numberValue: 'K', scoreDescp: "People who have launched their websites" },
    { number: 238, scoreDescp: "Experienced professionals ready to assist" },
