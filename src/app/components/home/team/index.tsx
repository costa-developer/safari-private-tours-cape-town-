                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    <h2 className="max-w-3xl">Meet Our Expert Team</h2>
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                        At DigitalizeIQ, our diverse and passionate team is dedicated to delivering cutting-edge web solutions that redefine digital experiences and drive client success.
                                    </p>
                                </div>
                            </div>
                        </div>
