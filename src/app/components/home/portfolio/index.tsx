                        ...
                        <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    <h2 className="max-w-3xl">Our Latest Work</h2>
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                        Discover how DigitalizeIQ transforms ideas into engaging digital realities.  
                                        Showcasing cutting-edge design, strategic collaborations, and measurable impact that drives business success.
                                    </p>
                                </div>
                            </div>
                        </div>
