...
function Pricing() {
    ...
    return (
        <section className="relative bg-lightgray dark:bg-secondary py-20 md:py-40">
            {/* Top-left badge */}
            <div className="absolute top-6 left-6 flex items-center gap-4 md:gap-8 z-10">
                <span className="bg-primary dark:text-white py-1.5 px-2.5 text-white font-medium rounded-full">05</span>
            </div>

            <div className="flex flex-col gap-24 relative z-0">
                            ...
                            <div className="flex flex-col xl:flex xl:flex-row items-start gap-8">
                                <div className="flex flex-col gap-11 w-full">
                                    <div className="flex flex-col gap-5 text-center">
                                        <h2 className="max-w-3xl mx-auto">Transparent and Affordable Plans</h2>
                                        <p className="max-w-2xl mx-auto text-secondary/70 dark:text-white/70">
                                          Choose from flexible pricing options designed to deliver exceptional value without compromising quality. Whether you're a startup or an established business, our plans scale with your needs.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div key={index} className="bg-white dark:bg-lightgray/10 p-3 sm:p-5 xl:p-12 flex flex-col gap-10">
                                        ...
                                        <div className="pt-10 border-t border-secondary/12 dark:border-white/12">
                                            ...
                                            <ul className="flex flex-col gap-3">
                                                {value?.planIncludes?.map((item:any, idx:any) => (
                                                    <li key={idx} className="flex items-center gap-1.5 sm:gap-4">
